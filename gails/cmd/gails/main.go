// Main entry point for the gails CLI.
package main
...
func main() {
	...
	update.NewSubCommandFunction("cli", "Updates the Gails CLI", commands.UpdateCLI)
...
func printFooter() {
	if !commands.DisableFooter {
		...
		linkText := term.Hyperlink("https://github.com/sponsors/leaanthony", "gails sponsor")
		printer.Println("If Gails is useful to you or your company, please consider sponsoring the project: " + pterm.LightBlue(linkText))
	}
}
